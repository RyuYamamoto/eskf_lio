...
#ifndef ESKF_LIO__ESKF_LIO_NODE_HPP_
#define ESKF_LIO__ESKF_LIO_NODE_HPP_
...
class ESKFLioNode : public rclcpp::Node
{
public:
  explicit ESKFLioNode(const rclcpp::NodeOptions & options);
  ~ESKFLioNode();
  ...
  void process();
  double get_lidar_scan_duration(const sensor_msgs::msg::PointCloud2::SharedPtr & msg);
